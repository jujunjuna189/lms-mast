...
<body class="bg-slate-50">
            ...
            <div class="flex gap-4 items-center">
                ...
                <div class="flex flex-col">
                    <div class="grow leading-3">
                        ...
                        <small class="text-white">Mas Terpadu Pakunagara</small>
                    </div>
                </div>
            </div>
            <div class="flex gap-4 items-center">
    ...
    <!-- Popup -->
    <div id="profile-menu" class="absolute right-0 top-16 mt-2 mr-4 w-40 bg-white rounded-md shadow-md p-2 z-50 hidden">
    ...
    <div class="w-full flex">
        <aside class="w-60 h-full bg-white border border-slate-200 hidden md:block fixed top-0 bottom-0">
            <nav class="pt-20">
                ...
                <div class="block px-4 py-2 hover:bg-gray-200 text-sm font-semibold cursor-pointer" onclick="window.location.href='<?= route('admin.spp') ?>'">SPP Siswa</div>
                <div class="block px-4 py-2 hover:bg-gray-200 text-sm font-semibold cursor-pointer" onclick="window.location.href='<?= route('admin.spp.payment') ?>'">Pembayaran</div>
            </nav>
        </aside>
        <div class="w-60"></div>
        <div class="p-5 grow">
